        ...
        <div className="d-md-flex justify-content-between align-items-center">
          ...
          <div className="col-md-5">
            <h1 className="smartInventoryReportingSystemHeading">
              <span className="smartInventoryReportingHeadingLatter">{pageData.length > 0 && pageData[0]?.ClindexHeadingBlueLatter}</span> {pageData.length > 0 && pageData[0]?.ClindexHeadingBlackLatter}
            </h1>
            <p className="smartInventoryReportingPara">
              {pageData.length > 0 && pageData[0]?.ClindexPara}
            </p>
            ...
            <div className="d-grid reportMannagmentItemsGrid">
              ...
              {
                pageData.length > 0 && pageData[0]?.clindexItems.map((mapedItemsData, index)=>(
              ...
              <div className="d-flex justify-content-center  justify-content-md-start">
                <Link
                  className={`text-decoration-none d-${pageData.length > 0 && pageData[0]?.learnMoreClindexVisibility}`}
                  to={`${pageData.length > 0 && pageData[0]?.learnMoreClindex}`}
                  onClick={() => window.scrollTo(0, 0)}
                >
                  <div className="learnButtonButtonBoxForsmartInventoryReportingItems ">
                    <p className="text-center  learnButtonCoustomTextInventoryReporting">
                      Learn More
                    </p>
                  </div>
                </Link>
          ...
          <div className="col-md-5 InventoryReportingItemsImgae">
            <img
