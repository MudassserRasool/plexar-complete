...
const NewsLatter = () => {
  return (
    <div className="testimonialContainer">
      ...
      <div className="d-grid align-items-center newsLatterBox container-md rounded rounded-md">
        <div className="d-md-flex align-items-center justify-content-center pt-4 ">
            ...
            <input type="text" placeholder="Drop your email here…" className="col-md-5 newsLatterCoustomInput ps-4 mt-3 mt-md-0" />
            <div className="sendNewsLatterButtonBox ">
                <div className="d-flex align-items-center gap-2 pag-md-3">
                <img src={NewslatterSendButtonIcon} alt="icon not loading"  className="sendButtonIcon"/>
